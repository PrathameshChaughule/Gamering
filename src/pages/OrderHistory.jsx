            ...
            <div className='-mt-2'>
              <div>
                ...
                <div className='flex items-center gap-3'>
                  ...
                  <div className={`w-fit px-3 rounded font-semibold cursor-pointer border ${details?.orderStatus === "Processing" ? "bg-yellow-700/30 text-yellow-500" : details?.orderStatus === "Rejected" ? `bg-red-900/40 text-red-500` : `bg-green-700/40 text-green-500`}  `}>
                    <span>{details?.orderStatus}</span>
                  </div>
                </div>
              </div>
              <div className='flex justify-between items-center'>
                <div className='w-[64%] p-4 mt-2 border bg-[#181A1E] border-[#2f354494] rounded'>
                  <span className='text-xl font-semibold'>Order Details</span>
                  <div>
                    {details?.games?.map((val, index) =>
                      <div key={index} className='flex items-center gap-5 border-t-2 border-[#2f354494] mt-2 pt-4 pb-2'>
                        <LazyLoadImage
                          src={val?.image}
                          effect="blur"
                        ...
                        <div className='flex justify-between w-full items-start'>
                          <div>
                            <span className='text-2xl ml-2 font-semibold'>{val?.title}</span>
                ...
                <div className='w-[33%] p-4 mt-2 border bg-[#181A1E] border-[#2f354494] rounded'>
                  ...
                  <div className='flex p-3 px-5 gap-5 items-center'>
                    ...
                    <div className='flex items-center justify-between w-full'>
                      ...
                      <div className='flex items-center gap-4'>
                        <div className={`w-fit text-lg p-1 px-6 rounded font-semibold cursor-pointer border ${val?.orderStatus === "Processing" ? "bg-yellow-700/30 text-yellow-500" : val?.orderStatus === "Rejected" ? `bg-red-900/40 text-red-500` : `bg-green-700/40 text-green-500`}  `}>
