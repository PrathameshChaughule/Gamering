                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div className='flex mb-2 mt-0.5 items-center gap-3'>
                                    ...
                                    />
                                    <input type="file" accept="image/*" onChange={(e) => setGame({
                                        ...game, image: game.image.map((img, index) =>
                                            index === 0 ? `/assets/image/${e.target.files[0].name}` : img
                                        )
                                    })} name="" id="" className='border w-60 px-4 text-gray-500 py-1.5 text-[17px] mt-1 rounded-lg bg-gray-200 dark:bg-[#0b0f19] dark:border-[#011743] border-gray-300' />
                                </div>
                                ...
                                <div className='flex mb-2 mt-0.5 items-center gap-3'>
                                    ...
                                    <input type="file" accept="image/*" onChange={(e) => setGame({
                                        ...game, image: game.image.map((img, index) =>
                                            index === 1 ? `/assets/image/${e.target.files[1].name}` : img
                                        )
                                    })} name="" id="" className='border w-60 px-4 text-gray-500 py-1.5 text-[17px] mt-1 rounded-lg bg-gray-200 dark:bg-[#0b0f19] dark:border-[#011743] border-gray-300' />
                                </div>
                                ...
                                <div className='flex mb-2 mt-0.5 items-center gap-3'>
                                    ...
                                    <input type="file" accept="image/*" onChange={(e) => setGame({
                                        ...game, image: game.image.map((img, index) =>
                                            index === 2 ? `/assets/image/${e.target.files[2].name}` : img
                                        )
                                    })} name="" id="" className='border w-60 px-4 text-gray-500 py-1.5 text-[17px] mt-1 rounded-lg bg-gray-200 dark:bg-[#0b0f19] dark:border-[#011743] border-gray-300' />
                                </div>
                                ...
                                <div className='flex mb-2 mt-0.5 items-center gap-3'>
                                    ...
                                    <input type="file" accept="image/*" onChange={(e) => setGame({
                                        ...game, image: game.image.map((img, index) =>
                                            index === 3 ? `/assets/image/${e.target.files[3].name}` : img
                                        )
                                    })} name="" id="" className='border w-60 px-4 text-gray-500 py-1.5 text-[17px] mt-1 rounded-lg bg-gray-200 dark:bg-[#0b0f19] dark:border-[#011743] border-gray-300' />
                                </div>
                                ...
                                <div className='flex mb-2 mt-0.5 items-center gap-3'>
                                    ...
                                    <input type="file" accept="image/*" onChange={(e) => setGame({
                                        ...game, image: game.image.map((img, index) =>
                                            index === 4 ? `/assets/image/${e.target.files[4].name}` : img
                                        )
                                    })} name="" id="" className='border w-60 px-4 text-gray-500 py-1.5 text-[17px] mt-1 rounded-lg bg-gray-200 dark:bg-[#0b0f19] dark:border-[#011743] border-gray-300' />
                                </div>
